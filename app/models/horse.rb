class Horse < ActiveRecord::Base
  ...
  belongs_to :sire_offspring
  belongs_to :dam_offspring, class_name: "SireOffspring"
...
class SireOffspring < ActiveRecord::Base
  has_many :sire_horses, class_name: "Horse", foreign_key: :sire_id
  has_many :dam_horses, class_name: "Horse", foreign_key: :dam_id
